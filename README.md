...
## Features
- Minimal prompt-based art generation
- Modern abstract visual styles
- Lightweight and fast UI
- Focus on aesthetic output over complexity

## Tech Stack
- Frontend: (z. B. Next.js / React / Vite)
- AI: Google Gemini / AI Studio integration
- Deployment: Vercel

## Purpose
This project explores the intersection of AI-generated creativity and minimal design systems.
